...
def place_boat_old(grid_state, amount_boat1, amount_boat2, amount_boat3):
...
def place_boat(grid_state, amount_boat1, amount_boat2, amount_boat3):
    ...
    while boat1_placed < amount_boat1 :
        print("Placer ", amount_boat1 - boat1_placed," bateaux de taille 1" )
    ...
    while boat2_placed < amount_boat2 :
        print("Placer ", amount_boat2 - boat2_placed," bateaux de taille 2" )
        boat_case = []
    ...
    while boat3_placed < amount_boat3 :
        print("Placer ", amount_boat3 - boat3_placed," bateaux de taille 3" )
        boat_case=[]
